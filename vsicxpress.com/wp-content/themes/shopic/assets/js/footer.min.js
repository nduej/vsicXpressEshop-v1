! function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        if (0 !== document.getElementsByClassName("shopic-handheld-footer-bar").length) {
            [].forEach.call(document.querySelectorAll(".shopic-handheld-footer-bar .search > a"), function(t) {
                t.addEventListener("click", function(e) {
                    t.parentElement.classList.toggle("active"), e.preventDefault()
                })
            });
            var e = document.getElementsByClassName("shopic-handheld-footer-bar"),
                t = document.forms,
                n = function(t) {
                    return function(e) {
