    ...
    function woosc_add_product(product_id) {
        ...
        if (woosc_limit) {
            ...
            if (woosc_vars.button_text_change === 'yes') {
                ...
                $(document.body).
                trigger('woosc_change_button_text', [product_id, woosc_vars.button_text_added]);
            }
        }
    }
    ...
    function woosc_remove_product(product_id) {
        ...
        if (product_id != 'all') {
            ...
            if (woosc_vars.button_text_change === 'yes') {
                ...
                $(document.body).
                trigger('woosc_change_button_text', [product_id, woosc_vars.button_text]);
            }
        } else {
            // remove all
            if (woosc_get_cookie(woosc_cookie_products) != '') {
            ...
            if (woosc_vars.button_text_change === 'yes') {
                ...
                $(document.body).
                trigger('woosc_change_button_text', ['all', woosc_vars.button_text]);
            }
        }
        ...
        if (woosc_get_cookie(woosc_cookie_products) != '') {
            ...
            woosc_products.forEach(function(entry) {
                ...
                if (woosc_vars.button_text_change === 'yes') {
                    ...
                    $(document.body).
                    trigger('woosc_change_button_text', [entry, woosc_vars.button_text_added]);
                }
            });
        }
    }
