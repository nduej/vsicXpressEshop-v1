(window.__googlesitekit_webpackJsonp = window.__googlesitekit_webpackJsonp || []).push([
    [13], {
        ...
        1091: function(t, e, r) {
            ...
            var y = {
                    resetInViewHook: l.a.mark((function t() {
                        var e, r;
                        return l.a.wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 2, o.a.commonActions.getRegistry();
                                case 2:
                                    return e = t.sent, r = e.select(g.b).getValue("useInViewResetCount"), t.next = 6, y.setValue("useInViewResetCount", r + 1);
                                case 6:
                    ...
                    setValues: function(t) {
                        return d()(v()(t), "values must be an object."), {
                            payload: {
                                values: t
                            },
                            type: "SET_VALUES"
                ...
                m = {
                    ...
                    selectors: {
                        ...
                        getInViewResetHook: function(t) {
                            return t.useInViewResetCount
                        }
                    }
                },
                O = o.a.combineStores(o.a.commonStore, m, Object(i.a)(g.b), Object(a.b)());
            O.initialState, O.actions, O.controls, O.reducer, O.resolvers, O.selectors;
            o.a.registerStore(g.b, O)
        },
        11: function(t, e, r) {
            "use strict";
            r.d(e, "w", (function() {
                ...
                p = function(t) {
                    return d()(JSON.stringify(function t(e) {
                        ...
                        return Object.keys(e).sort().forEach((function(n) {
                            var o = e[n];
                            o && "object" === l()(o) && !Array.isArray(o) && (o = t(o)), r[n] = o
                        })), r
                    }(t)))
                };
            var v = r(80),
            ...
            function O(t) {
                for (var e = t, r = 0, n = [h, y, m]; r < n.length; r++) {
                    e = (0, n[r])(e)
                }
                return e
            }
        ...
        40: function(t, e, r) {
            ...
            (function(t) {
                        ...
                        var e = i()(o.a.mark((function e(r) {
                            ...
                            return o.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        return e.prev = 3, a = "__storage_test__", n.setItem(a, a), n.removeItem(a), e.abrupt("return", !0);
                                    case 10:
                ...
                function g() {
                    return (g = i()(o.a.mark((function e() {
                        var r, n, a;
                        return o.a.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                ...
                var b = function() {
                    ...
                    h = function() {
                        var e = i()(o.a.mark((function e(r, n) {
                            var a, i, c, u, s, f, d, p, g = arguments;
                            return o.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return a = g.length > 2 && void 0 !== g[2] ? g[2] : {}, i = a.ttl, c = void 0 === i ? 3600 : i, u = a.timestamp, s = void 0 === u ? Math.round(Date.now() / 1e3) : u, f = a.isError, d = void 0 !== f && f, e.next = 3, v();
                                    case 3:
                                        if (!(p = e.sent)) {
                                            e.next = 14;
                                            break
                                        }
                                        return e.prev = 5, p.setItem("".concat(l).concat(r), JSON.stringify({
                                            timestamp: s,
                                            ttl: c,
                                            value: n,
                                            isError: d
                            ...
                            return o.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        ...
                                        for (e.prev = 4, n = [], a = 0; a < r.length; a++) 0 === (i = r.key(a)).indexOf(l) && n.push(i.substring(l.length));
        ...
        50: function(t, e, r) {
            ...
            function u(t, e) {
                ...
                var r = new URL(t),
                    o = t.replace(r.origin, "");
                if (o.length < e) return o;
                var a = o.length - Math.floor(e) + 1;
                return "…" + o.substr(a)
            }
        },
        51: function(t, e, r) {
            ...
            function b() {
                var t = {
                    ...
                    getError: function(t, e, r) {
                        var n = t.error,
                            o = t.errors;
                        return e || r ? (u()(e, "baseName is required."), o[v(e, r)]) : n
                    },
        ...
        63: function(t, e, r) {
            ...
            var n = r(29),
                ...
                i = function(t) {
                    ...
                    return {
                        __html: a.a.sanitize(t, e)
                    }
                };

            function c(t) {
                var e, r = "object" === o()(t) ? t.toString() : t;
                ...
                var h = function(t) {
                        ...
                        return {
                            ...
                            formatDecimal: function() {
                                ...
                                return Object(v.sprintf)(
                                    /* translators: 1: formatted seconds, 2: formatted minutes, 3: formatted hours */
                                    Object(v._x)("%3$s %2$s %1$s", "duration of time: hh mm ss", "google-site-kit"), o ? e : "", n ? a : "", r ? i : "").trim()
                            }
                        }
                    },
                    m = function(t) {
                    ...
                    O = function(t) {
                        ...
                        return 1e6 <= t ? Object(v.sprintf)( // translators: %s: an abbreviated number in millions.
                            ...
                            Object(v.__)("%sK", "google-site-kit"), S(m(t), t % 10 == 0 ? {} : e)) : S(t, {
                            signDisplay: "never",
                            maximumFractionDigits: 1
                        })
                    },
                    w = function(t) {
                        ...
                        var n = r,
                            o = n.style,
                            a = void 0 === o ? "metric" : o;
                        return "metric" === a ? O(t) : "duration" === a ? h(t, e) : S(t, r)
                    },
                    j = p()(console.warn),
                    S = function(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        ...
                        try {
                            ...
                            j("Site Kit numberFormat error: Intl.NumberFormat( ".concat(JSON.stringify(n), ", ").concat(JSON.stringify(a), " ).format( ").concat(i()(t), " )"), e.message)
                        }
                        for (var c = {
            ...
            (function(t) {
                ...
                var u = function() {
                        ...
                        return u.setAttribute("class", "screen-reader-text"), u.textContent = Object(a.sprintf)(
                            ...
                            Object(a._n)("%d notification", "%d notifications", t, "google-site-kit"), t), i.appendChild(c), i.appendChild(u), e && null === n && e.appendChild(i), r && null === o && r.appendChild(i), i
                    },
                    s = function() {
        ...
        85: function(t, e, r) {
            ...
            (function(t) {
                ...
                var n = r(194),
                    ...
                    i = function(t) {
                        var e, r, n, o, a, i, c, u, s, l, f, d, p, v, g;
                        if (void 0 !== t) return 1 === (null == t || null === (e = t[0]) || void 0 === e || null === (r = e.data) || void 0 === r || null === (n = r.rows) || void 0 === n ? void 0 : n.length) || (null == t || null === (o = t[0]) || void 0 === o || null === (a = o.data) || void 0 === a || null === (i = a.rows) || void 0 === i || null === (c = i[0]) || void 0 === c || null === (u = c.metrics) || void 0 === u || null === (s = u[0]) || void 0 === s || null === (l = s.values) || void 0 === l ? void 0 : l[0]) === (null == t || null === (f = t[0]) || void 0 === f || null === (d = f.data) || void 0 === d || null === (p = d.totals) || void 0 === p || null === (v = p[0]) || void 0 === v || null === (g = v.values) || void 0 === g ? void 0 : g[0])
                    },
                    c = function(t, e) {
        ...
        87: function(t, e, r) {
            ...
            (function(t) {
                ...
                function a(e, r) {
                    var a, i = Object(n.a)(r);
                    return function() {
                        var r = t.document;
                        if (void 0 === a && (a = !!r.querySelector("script[".concat(o.b, "]"))), !a) {
                            var n = r.createElement("script");
                            n.setAttribute(o.b, ""), n.async = !0, n.src = "https://www.googletagmanager.com/gtag/js?id=".concat(e.trackingID, "&l=").concat(o.a), r.head.appendChild(n), i("js", new Date), i("config", e.trackingID, {
                ...
                function p(e, r, n, a) {
                    ...
                    return function() {
                        var r = u()(o.a.mark((function r(c, u, s, f) {
                            var p, v, g, b, h, y, m, O, w, j;
                            return o.a.wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    case 0:
                                        if (b = e.activeModules, h = e.referenceSiteURL, y = e.trackingEnabled, m = e.trackingID, O = e.userIDHash, y) {
                                            r.next = 3;
                                            break
                                        }
                                    ...
                                    case 3:
                                        return n(), w = null !== (p = null === (v = t._googlesitekitUserData) || void 0 === v || null === (g = v.user) || void 0 === g ? void 0 : g.roles) && void 0 !== p ? p : [], j = {
                                            ...
                                            i("event", u, d(d({}, j), {}, {
                                                event_callback: o
                                            })), (null === (e = a._gaUserPrefs) || void 0 === e || null === (r = e.ioo) || void 0 === r ? void 0 : r.call(e)) && o()
                                        })));
                                    case 7:
                                    case "end":
                                        return r.stop()
            ...
            var n = r(17),
                ...
                g = function(t) {
                    ...
                    var r = {},
                        ...
                        a = (e = {}, i()(e, "DELETE_SNAPSHOT", (function() {
                            return Object(p.a)("datastore::cache::".concat(t))
                        })), i()(e, "CREATE_SNAPSHOT", v((function(e) {
                            return function() {
                                return Object(p.d)("datastore::cache::".concat(t), e.stores[t].store.getState())
                            }
